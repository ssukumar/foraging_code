...
if logfnid ==0
    colheaderstr={'frame';'time';'x';'y';'vx';'vy';'fx';'fy';'fpfx';...
        ...
        'avstatenumber';'robotstatenumber';'cursorx';'cursory';...
        'cursorvelx';'cursorvely';'cursoraccx';'cursoraccy'};
elseif logfnid ==7
...
elseif logfnid ==15
    colheaderstr={'frame';'time';'x';'y';'vx';'vy';'fx';'fy'; 'time_ms';...
        'ax_curr'; 'ay_curr'; 'ax_rot'; 'ay_rot';'theta_s'; 'theta_e';...
        'mass_val'; 'targetx';'targety';'homex';'homey';'statenumber';...
        'avstatenumber';'robotstatenumber'; 'flag_berry';'cursorx';...
        'cursory';'trial_dist'; 'job_id';'score';'grip_force';...
        'ax_curr'; 'ay_curr'};
end
