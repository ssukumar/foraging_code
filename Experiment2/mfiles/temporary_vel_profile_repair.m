...
elseif sidebyside
    ...
    if new_max_ix_ylow <= new_max_ix_yhigh
        xlow = xlow + (new_max_ix_yhigh- new_max_ix_ylow);
        ylowhigh_diff = yhigh - [zeros(1,(new_max_ix_yhigh- new_max_ix_ylow)),...
            ylow];
        ylowhigh_ser = sqrt(yhigh_ser.^2 + [zeros(1,(new_max_ix_yhigh- ...
            new_max_ix_ylow)), ylow_ser].^2);
    else 
        xhigh = xhigh + (new_max_ix_ylow- new_max_ix_yhigh);
        ylowhigh_diff = [zeros(1,(new_max_ix_yhigh- new_max_ix_ylow)),yhigh]...
            - ylow;
        ylowhigh_ser = sqrt([zeros(1,(new_max_ix_yhigh- new_max_ix_ylow))...
            ,yhigh_ser].^2 + ylow_ser.^2);
    end
    ...
    if new_max_ix_yprb_low <= new_max_ix_yprb_high
        ...
        yprb_lowhigh_diff = yprb_high - [zeros(1,(new_max_ix_yprb_high- new_max_ix_yprb_low)),...
            yprb_low];
