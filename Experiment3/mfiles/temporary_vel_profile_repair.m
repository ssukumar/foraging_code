...
if ~subplt
    ...
    dataObjs2 = axObjs2.Children;
    hold on
    yhigh = dataObjs2(3).YData(340:800);
    yhigh_ser = dataObjs2(4).YData(340:800)' - yhigh;
    yprb_high = dataObjs2(1).YData(200:600);
    yprb_high_ser = dataObjs2(2).YData(200:600)' - yprb_high;
    xprb_high = (1:length(yprb_high))+1000;
    xhigh = (1:length(yhigh))+1500;
    figure(fig_h)
    hold on
